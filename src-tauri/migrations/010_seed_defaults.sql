...
-- Hash: bcrypt cost 10, generated by project bcrypt dependency (v0.14), verified against admin123
INSERT OR IGNORE INTO users (username, password_hash, role, display_name) VALUES
    ('admin', '$2b$10$0VhA9Hg.jTBd/bzmenZFAu5ghEAQdUzozRiYH2G4PWICK5ZIvlTee', 'Admin', 'Administrateur');
